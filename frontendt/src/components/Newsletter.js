        ...
        <div className="w-full py-16 text-white px-4">
            <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
                ...
                <div className="my-4">
                    ...
                    <p className="text-right text-white">We care about the protection of your data. Read our <a className="text-right text-[#00df9a]" href="/privacypolicy">Privacy Policy</a></p>
